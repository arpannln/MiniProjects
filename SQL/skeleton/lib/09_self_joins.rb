...
def lrt_stops
  ...
  execute(<<-SQL)
    ...
    FROM
      stops
    JOIN routes ON id = routes.stop_id
...
def craiglockhart_and_tollcross
  ...
  execute(<<-SQL)
    ...
    JOIN stops AS start ON a.stop_id = start.id
    JOIN stops AS finish ON b.stop_id = finish.id
    WHERE
      start.name = 'Craiglockhart' AND finish.name = 'Tollcross'
  SQL
end
